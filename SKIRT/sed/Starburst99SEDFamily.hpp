...
/** An instance of the Starburst99SEDFamily class represents a family of Starburst99 SEDs for
    ...
    by the initial mass of the SSP. Geneva High tracks at Z = 0.001, 0.004, 0.008, 0.02, 0.04 were
    selected. Initial time was 0.01 Myr ending at 1.049 Gyr with a time step of 1 Myr. All other
    parameters were set to the default values recommended on the STARBURST99 webpage. Only the
    stellar emission was used.
    ...
    The library data was generated by the code of Starburst99 (see
    https://massivestars.stsci.edu/starburst99/docs/) and converted to SKIRT stored table
    format for inclusion as a resource file. The stored table is opened during setup, and it is
    subsequently interpolated to the desired parameters and wavelength grid when needed.
