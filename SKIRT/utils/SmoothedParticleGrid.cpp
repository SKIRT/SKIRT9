...
namespace
{
    ...
    void makegrid(const vector<SmoothedParticle>& pv, int dir, int gridsize,
...
SmoothedParticleGrid::SmoothedParticleGrid(const vector<SmoothedParticle>& pv, int gridsize)
    : _m(gridsize)
{
