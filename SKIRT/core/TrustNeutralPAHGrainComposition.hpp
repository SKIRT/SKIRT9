...
/** The TrustNeutralPAHGrainComposition class represents the optical and calorimetric properties of
    neutral PAH molecules according to the dust model used for the TRUST benchmark (Gordon et al.
    ...
    Zubko, Dwek, and Arendt 2004, ApJS, 152, 211. The bulk mass density for the PAH grains is set
    to the value of 2240 kg/m3. */
class TrustNeutralPAHGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(TrustNeutralPAHGrainComposition, GrainComposition,
