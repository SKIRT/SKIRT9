...
void MRNDustMix::setupSelfBefore()
{
    ...
    addPopulation(new DraineSilicateGrainComposition(this), sizeDistribution,
                  _numSilicateSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, Cs);

    addPopulation(new DraineGraphiteGrainComposition(this), sizeDistribution,
                  _numGraphiteSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, Cg);
}
