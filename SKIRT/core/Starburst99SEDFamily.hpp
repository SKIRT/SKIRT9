...
/** An instance of the Starburst99SEDFamily class represents a family of Starburst99 SEDs for
    ...
    selected. Initial time was 0.01e6 yr and ended at 1.049e+09 yr, time step was 1e6 yr.
    All other parameters were set to the default values recommended on the STARBURST99 webpage. The 
    stellar emission was only used in SKIRT.
    ...
    The library data was generated by the code of Starburst99. 
    <tt>https://massivestars.stsci.edu/starburst99/docs/default.htm<tt> and
