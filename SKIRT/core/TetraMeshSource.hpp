...
#ifndef TETRAMESHSOURCE_HPP
#define TETRAMESHSOURCE_HPP

#include "MeshSource.hpp"

////////////////////////////////////////////////////////////////////

/** A TetraMeshSource instance represents a primary radiation source with a spatial and spectral
    luminosity distribution described by a list of sites generating a Tetra tesselation of a
    ...
    this TetraMeshSource instance, including the selected %SEDFamily.
    ...
    (i.e. the location defining a particular Tetra cell). If the \em importVelocity option is
...
class TetraMeshSource : public MeshSource
{
    ITEM_CONCRETE(TetraMeshSource, MeshSource, "a primary source imported from data represented on a Tetra mesh")
    ITEM_END()
