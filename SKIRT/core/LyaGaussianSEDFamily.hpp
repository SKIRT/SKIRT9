...
/** An instance of the LyaGaussianSEDFamily class represents a family of Gaussian spectra around
    ...
    around the center for the a dispersion of \f$s=1000\,\mathrm{km/s}\f$. This results in a range
    of \f$1179 \text{\AA} \le \lambda \le 1253 \text{\AA}\f$. The source wavelength range
    configured by the user must fully contain this intrinsic wavelength range.

    Whenever a tabular form of a black body %SED is requested, this class uses 100 wavelength
