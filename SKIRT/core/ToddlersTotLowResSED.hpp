...
#ifndef TODDLERSTOTLOWRESSED_HPP
#define TODDLERSTOTLOWRESSED_HPP

#include "FamilySED.hpp"

////////////////////////////////////////////////////////////////////

/** ToddlersTotLowResSED is a class representing the family of 
 ...
 */
class ToddlersTotLowResSED : public FamilySED
{
    ITEM_CONCRETE(ToddlersTotLowResSED, FamilySED, "a Toddlers SED family for low resolution total emission (lines + continuum, R=300) from Hii regions")
        ATTRIBUTE_TYPE_DISPLAYED_IF(ToddlersTotLowResSED, "Level2")
