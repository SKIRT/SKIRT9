...
/** A VoronoiMeshMedium instance represents a transfer medium with a spatial density distribution
    ...
    input file should contain 4 to 9 columns, depending on the options configured by the user for
    ...
    \f$v_y\f$, \f$v_z\f$ velocity components of the site (considered as the bulk velocity for the
    mass represented by the site). */
class VoronoiMeshMedium : public MeshMedium
{
