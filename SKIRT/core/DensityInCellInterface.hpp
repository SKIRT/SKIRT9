...
/** DensityInCellInterface is a pure interface. It is implemented by spatial grids that offer a
    ...
    interface, it will call the density() function in this interface rather than sampling the
...
public:
    ...
    /** This function returns the density for medium component \em h in the spatial grid cell with
        index \em m. */
