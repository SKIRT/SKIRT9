...
#ifndef DRAINELI2007IONIZEDPAHSAMEEXTABSGRAINCOMPOSITION_HPP
#define DRAINELI2007IONIZEDPAHSAMEEXTABSGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007IonizedPAHSameExtAbsGrainComposition class represents the optical and calorimetric properties
...
class DraineLi2007IonizedPAHSameExtAbsGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007IonizedPAHSameExtAbsGrainComposition, GrainComposition, "a Draine ionized PAH dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007IonizedPAHSameExtAbsGrainComposition(SimulationItem* parent);
