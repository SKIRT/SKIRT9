...
#ifndef TODDLERSLINESEDFAMILY_HPP
#define TODDLERSLINESEDFAMILY_HPP
...
/** An instance of the ToddlersLineSEDFamily class represents the family of 
...
class ToddlersLineSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(ToddlersLineSEDFamily, SEDFamily, "A Toddlers SED family for line emission from Hii regions")
        ATTRIBUTE_TYPE_DISPLAYED_IF(ToddlersLineSEDFamily, "Level2")
    ITEM_END()
...
public:
    /** This constructor can be invoked programmatically by classes that use a hard-coded SED
        ...
        */
    explicit ToddlersLineSEDFamily(SimulationItem* parent);
