...
/** The VernerCrossSections namespace provides photoionization cross-sections for all relevant
    ...
    the fitted range. All functions are defined inline for performance. */
namespace VernerCrossSections
{
    // ---- ionization potentials [eV] ----

    constexpr double HI_eV = 13.6;
    constexpr double HeI_eV = 24.59;
    constexpr double HeII_eV = 54.42;

    constexpr double CI_eV = 11.26;
    constexpr double CII_eV = 24.38;
    constexpr double CIII_eV = 47.89;
    constexpr double CIV_eV = 64.49;
    constexpr double CV_eV = 392.1;
    constexpr double CVI_eV = 490.;

    constexpr double NI_eV = 14.53;
    constexpr double NII_eV = 29.6;
    constexpr double NIII_eV = 47.45;
    constexpr double NIV_eV = 77.47;
    constexpr double NV_eV = 97.89;
    constexpr double NVI_eV = 552.1;
    constexpr double NVII_eV = 667.1;

    constexpr double OI_eV = 13.62;
    constexpr double OII_eV = 35.12;
    constexpr double OIII_eV = 54.94;
    constexpr double OIV_eV = 77.41;
    constexpr double OV_eV = 113.9;
    constexpr double OVI_eV = 138.1;
    constexpr double OVII_eV = 739.2;
    constexpr double OVIII_eV = 871.4;

    constexpr double NeI_eV = 21.56;
    constexpr double NeII_eV = 40.96;
    constexpr double NeIII_eV = 63.46;
    constexpr double NeIV_eV = 97.12;
    constexpr double NeV_eV = 126.2;
    constexpr double NeVI_eV = 157.9;
    constexpr double NeVII_eV = 207.3;
    constexpr double NeVIII_eV = 239.1;

    constexpr double MgI_eV = 7.646;
    constexpr double MgII_eV = 15.04;
    constexpr double MgIII_eV = 80.14;
    constexpr double MgIV_eV = 109.3;
    constexpr double MgV_eV = 141.3;
    constexpr double MgVI_eV = 186.5;
    constexpr double MgVII_eV = 224.9;
    constexpr double MgVIII_eV = 266.;
    constexpr double MgIX_eV = 328.2;
    constexpr double MgX_eV = 367.5;

    constexpr double SiI_eV = 8.152;
    constexpr double SiII_eV = 16.35;
    constexpr double SiIII_eV = 33.49;
    constexpr double SiIV_eV = 45.14;
    constexpr double SiV_eV = 166.8;
    constexpr double SiVI_eV = 205.1;
    constexpr double SiVII_eV = 246.5;
    constexpr double SiVIII_eV = 303.2;
    constexpr double SiIX_eV = 351.1;
    constexpr double SiX_eV = 401.4;
    constexpr double SiXI_eV = 476.1;
    constexpr double SiXII_eV = 523.5;

    constexpr double SI_eV = 10.36;
    constexpr double SII_eV = 23.33;
    constexpr double SIII_eV = 34.83;
    constexpr double SIV_eV = 47.31;

    constexpr double FeI_eV = 7.902;
    constexpr double FeII_eV = 16.19;
    constexpr double FeIII_eV = 30.65;
    constexpr double FeIV_eV = 54.8;
    constexpr double FeV_eV = 75.01;
    constexpr double FeVI_eV = 99.06;
    constexpr double FeVII_eV = 125.;
    constexpr double FeVIII_eV = 151.1;
    constexpr double FeIX_eV = 233.6;
    constexpr double FeX_eV = 262.1;
    constexpr double FeXI_eV = 290.2;
    constexpr double FeXII_eV = 330.8;
    constexpr double FeXIII_eV = 361.;
    constexpr double FeXIV_eV = 392.2;
    constexpr double FeXV_eV = 457.;
    constexpr double FeXVI_eV = 489.3;

    // total number of ions with cross-sections
    constexpr int numIons = 74;
    ...
    {
        if (E < OVIII_eV || E > 50000.) return 0.;
        double x = E / 27.54;
        double xm1 = x - 1.;
    ...
    {
        if (E < NeIII_eV || E > 913.1) return 0.;
    ...
    {
        if (E < NeVIII_eV || E > 1125.) return 0.;
        double x = E / 10.03;
        double xm1 = x - 1.;
    ...
    {
        if (E < MgVIII_eV || E > 1558.) return 0.;
    ...
    {
        if (E < SiIII_eV || E > 131.1) return 0.;
    ...
    {
        if (E < SiVIII_eV || E > 2058.) return 0.;
    ...
    {
        if (E < FeIII_eV || E > 87.05) return 0.;
    ...
    {
        if (E < FeVII_eV || E > 178.3) return 0.;
    ...
    {
        if (E < FeVIII_eV || E > 205.5) return 0.;
    ...
    {
        if (E < FeXIII_eV || E > 1081.) return 0.;
    ...
    inline double ionizationPotential(int ion)
    {
        static constexpr double ip[] = {
            HI_eV,     HeI_eV,    HeII_eV, CI_eV,    CII_eV,   CIII_eV,   CIV_eV,   CV_eV,   CVI_eV,   NI_eV,
            NII_eV,    NIII_eV,   NIV_eV,  NV_eV,    NVI_eV,   NVII_eV,   OI_eV,    OII_eV,  OIII_eV,  OIV_eV,
            OV_eV,     OVI_eV,    OVII_eV, OVIII_eV, NeI_eV,   NeII_eV,   NeIII_eV, NeIV_eV, NeV_eV,   NeVI_eV,
            NeVII_eV,  NeVIII_eV, MgI_eV,  MgII_eV,  MgIII_eV, MgIV_eV,   MgV_eV,   MgVI_eV, MgVII_eV, MgVIII_eV,
            MgIX_eV,   MgX_eV,    SiI_eV,  SiII_eV,  SiIII_eV, SiIV_eV,   SiV_eV,   SiVI_eV, SiVII_eV, SiVIII_eV,
            SiIX_eV,   SiX_eV,    SiXI_eV, SiXII_eV, SI_eV,    SII_eV,    SIII_eV,  SIV_eV,  FeI_eV,   FeII_eV,
            FeIII_eV,  FeIV_eV,   FeV_eV,  FeVI_eV,  FeVII_eV, FeVIII_eV, FeIX_eV,  FeX_eV,  FeXI_eV,  FeXII_eV,
            FeXIII_eV, FeXIV_eV,  FeXV_eV, FeXVI_eV};
        return ip[ion];
    }

    /** Returns the photoionization cross-section [cm^2] for the given linear ion index
        at photon energy E [eV]. */
    inline double sigma(int ion, double E)
    {
        switch (ion)
        {
    ...
    constexpr int firstH = 0;
    constexpr int numH = 1;  // HI only (HII is fully ionized, no XS)
    constexpr int firstHe = 1;
    constexpr int numHe = 2;  // HeI, HeII
    constexpr int firstC = 3;
    constexpr int numC = 6;  // CI-CVI
    constexpr int firstN = 9;
    constexpr int numN = 7;  // NI-NVII
    constexpr int firstO = 16;
    constexpr int numO = 8;  // OI-OVIII
    constexpr int firstNe = 24;
    constexpr int numNe = 8;  // NeI-NeVIII
    constexpr int firstMg = 32;
    constexpr int numMg = 10;  // MgI-MgX
    constexpr int firstSi = 42;
    constexpr int numSi = 12;  // SiI-SiXII
    constexpr int firstS = 54;
    constexpr int numS = 4;  // SI-SIV
    constexpr int firstFe = 58;
    constexpr int numFe = 16;  // FeI-FeXVI
}
