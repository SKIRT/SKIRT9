...
#ifndef DRAINELI2007IONIZEDPAHGRAINCOMPOSITION_HPP
#define DRAINELI2007IONIZEDPAHGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007IonizedPAHGrainComposition class represents the optical and calorimetric properties
...
class DraineLi2007IonizedPAHGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007IonizedPAHGrainComposition, GrainComposition, "a Draine ionized PAH dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007IonizedPAHGrainComposition(SimulationItem* parent);
