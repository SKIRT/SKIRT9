...
#ifndef TODDLERSCONTSED_HPP
#define TODDLERSCONTSED_HPP

#include "FamilySED.hpp"

////////////////////////////////////////////////////////////////////

/** ToddlersContSED is a class representing the family of 
    ...
    used for the continuum part of the SED.

    TODDLERS = Time evolution of Dust Diagnostics and Line Emission from Regions
    containing young Stars.
 */
class ToddlersContSED : public FamilySED
{
    ITEM_CONCRETE(ToddlersContSED, FamilySED, "an Hii region continuum only SED from the TODDLERS model")
        ATTRIBUTE_TYPE_DISPLAYED_IF(ToddlersContSED, "Level2")
