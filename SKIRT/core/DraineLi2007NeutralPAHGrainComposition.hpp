...
#ifndef DRAINELI2007NEUTRALPAHGRAINCOMPOSITION_HPP
#define DRAINELI2007NEUTRALPAHGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007NeutralPAHGrainComposition class represents the optical and calorimetric properties of
...
class DraineLi2007NeutralPAHGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007NeutralPAHGrainComposition, GrainComposition, "a Draine neutral PAH dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007NeutralPAHGrainComposition(SimulationItem* parent);
