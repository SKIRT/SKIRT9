...
public:
    ...
    /** This function calculates the optical depth along a path through the medium system defined
        ...
        information on the path through the spatial grid into the photon packet object.

        With this information given, the function then calculates the optical depth for each path
