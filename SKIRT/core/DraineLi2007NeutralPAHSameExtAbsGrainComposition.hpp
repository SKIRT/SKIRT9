...
#ifndef DRAINELI2007NEUTRALPAHSAMEEXTABSGRAINCOMPOSITION_HPP
#define DRAINELI2007NEUTRALPAHSAMEEXTABSGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007NeutralPAHSameExtAbsGrainComposition class represents the optical and calorimetric properties of
    neutral PAH dust grains. The optical properties are taken from Bruce Draine's website
    (https://www.astro.princeton.edu/~draine/dust/dust.diel.html) as those for neutral
...
class DraineLi2007NeutralPAHSameExtAbsGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007NeutralPAHSameExtAbsGrainComposition, GrainComposition, "a Draine neutral PAH dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007NeutralPAHSameExtAbsGrainComposition(SimulationItem* parent);
