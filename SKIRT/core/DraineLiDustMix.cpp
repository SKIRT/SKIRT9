...
void DraineLiDustMix::setupSelfBefore()
{
    ...
    addPopulation(new DustEmGrainComposition(this, DustEmGrainComposition::GrainType::aSil, 3500.),
                  new ModifiedPowerLawGrainSizeDistribution(this, 3.1e-10, 2.0e-6, -3.21,
                                                            1.64e-7, 1.00e-7, 3., 1.64e-7, 0.3, 1.),
    ...
    addPopulation(new DustEmGrainComposition(this, DustEmGrainComposition::GrainType::Gra, 2240.),
                  new ModifiedPowerLawGrainSizeDistribution(this, 3.1e-10, 2.0e-6, -2.54,
                                                            1.07e-8, 4.28e-7, 3., 1.07e-8, -0.165, 1.),
