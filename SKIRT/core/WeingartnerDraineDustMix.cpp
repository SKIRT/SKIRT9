...
void WeingartnerDraineDustMix::setupSelfBefore()
{
    ...
    case WeingartnerDraineDustMix::Environment::MilkyWay:
        addPopulation(new DraineSilicateGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_sil, amax_sil, &dnda_sil_mwy),
        ...
        addPopulation(new DraineGraphiteGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_gra, amax_gra, &dnda_gra_mwy),
        ...
        addPopulation(new DraineNeutralPAHGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_pah, amax_pah, &dnda_pah_mwy),
    ...
    case WeingartnerDraineDustMix::Environment::LMC:
        addPopulation(new DraineSilicateGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_sil, amax_sil, &dnda_sil_lmc),
                      _numSilicateSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 1.);
        addPopulation(new DraineGraphiteGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_gra, amax_gra, &dnda_gra_lmc),
                      _numGraphiteSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 1.);
        addPopulation(new DraineNeutralPAHGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_pah, amax_pah, &dnda_pah_lmc),
                      _numPAHSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 0.5);
        addPopulation(new DraineIonizedPAHGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_pah, amax_pah, &dnda_pah_lmc),
                      _numPAHSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 0.5);
    ...
    case WeingartnerDraineDustMix::Environment::SMC:
        addPopulation(new DraineSilicateGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_sil, amax_sil, &dnda_sil_smc),
                      _numSilicateSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 1.);
        addPopulation(new DraineGraphiteGrainComposition(this),
                      new FunctionSizeDistribution(this, amin_gra, amax_gra, &dnda_gra_smc),
                      _numGraphiteSizes, GrainPopulation::NormalizationType::FactorOnSizeDistribution, 1.);
        break;
    }
}
