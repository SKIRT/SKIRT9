...
#ifndef DRAINELI2007SILICATEGRAINCOMPOSITION_HPP
#define DRAINELI2007SILICATEGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007SilicateGrainComposition class represents the optical and calorimetric properties of
    ...
    grains. */
class DraineLi2007SilicateGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007SilicateGrainComposition, GrainComposition, "a Draine silicate dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007SilicateGrainComposition(SimulationItem* parent);
