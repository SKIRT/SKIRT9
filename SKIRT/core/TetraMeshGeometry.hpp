...
/** A TetraMeshGeometry instance represents a 3D geometry with a spatial density distribution
    ...
    for this TetraMeshGeometry instance:
...
class TetraMeshGeometry : public MeshGeometry, public TetraMeshInterface
{
    ITEM_CONCRETE(TetraMeshGeometry, MeshGeometry, "a geometry imported from data represented on a Tetra mesh")
        ATTRIBUTE_TYPE_INSERT(TetraMeshGeometry, "TetraMeshInterface")
    ITEM_END()
