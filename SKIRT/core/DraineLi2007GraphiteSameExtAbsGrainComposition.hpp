...
#ifndef DRAINELI2007GRAPHITESAMEEXTABSGRAINCOMPOSITION_HPP
#define DRAINELI2007GRAPHITESAMEEXTABSGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007GraphiteSameExtAbsGrainComposition class represents the optical and calorimetric properties of
...
class DraineLi2007GraphiteSameExtAbsGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007GraphiteSameExtAbsGrainComposition, GrainComposition, "a Draine graphite dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007GraphiteSameExtAbsGrainComposition(SimulationItem* parent);
