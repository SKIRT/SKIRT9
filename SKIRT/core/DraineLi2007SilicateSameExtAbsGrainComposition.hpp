...
#ifndef DRAINELI2007SILICATESAMEEXTABSGRAINCOMPOSITION_HPP
#define DRAINELI2007SILICATESAMEEXTABSGRAINCOMPOSITION_HPP

#include "GrainComposition.hpp"

////////////////////////////////////////////////////////////////////

/** The DraineLi2007SilicateSameExtAbsGrainComposition class represents the optical and calorimetric properties of
    ...
    grains. */
class DraineLi2007SilicateSameExtAbsGrainComposition : public GrainComposition
{
    ITEM_CONCRETE(DraineLi2007SilicateSameExtAbsGrainComposition, GrainComposition, "a Draine silicate dust grain composition")
    ITEM_END()
...
public:
    ...
    explicit DraineLi2007SilicateSameExtAbsGrainComposition(SimulationItem* parent);
